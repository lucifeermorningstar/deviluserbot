...
async def _(event):
    ...
    if s==2:
        await event.edit("Ap Itne Cute Ho Ki Agar Mai Msg Na Bhi Karna Chahu.To Bhi Mera Hath Khud Keypad Pr Chalne Lagta Hai.")
    if s==3:
    ...
    if s==6:
        await event.edit("Aap choro ke raja lagte ho kyuki aapne mera dil chura liya hain")
    if s==7:
