#Syntax: .update
#\nAll Credits goes to © @hellboi_atul, DARKCOBRA
...
UPSTREAM_REPO_URL = "https://github.com/lucifeermorningstar/deviluserbot"
...
async def upstream(ups):
    ...
    if force_update:
        ...
        await ups.edit('`Updating Devil userbot, please wait....you are my best boss🤗😇')
    if HEROKU_API_KEY is not None:
        ...
        await ups.edit("`⚜️Updating Devil Userbot⚜️\n\nPlease wait 10 min😁😁\nThen try .alive to check` 😎😎\n\n**Powered by :-**\n©DEVILUSERBOT ")
