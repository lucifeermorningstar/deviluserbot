...
OFFICIAL_UPSTREAM_REPO = "https://github.com/lucifeermorningstar/deviluserbot"
BOT_IS_UP_TO_DATE = "☠️DevilUserBot☠️ is up-to-date!â"
NEW_BOT_UP_DATE_FOUND = (
    "**DevilUserBot  Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**ï¹ï¹Updating DevilUserBot* \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Status** : `Â«Pulling UpdatesÂ»` \nã**Thank You For Using DevilUserBot !**ã")
...
CMD_HELP.update(
    {
        "UPP": "**Plugin : **`upp`\
    \n\n**Syntax : **`.upp`\
    \n**Function : **give this plugin for hell user or dc user then he use this plugin to shift Devil UserBot"
    }
)
