...
@devilbot.on(admin_cmd(pattern="sin ?(.*)"))
@devilbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="cos ?(.*)"))
@devilbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="tan ?(.*)"))
@devilbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="cosec ?(.*)"))
@devilbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="sec ?(.*)"))
@devilbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="cot ?(.*)"))
@devilbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="square ?(.*)"))
@devilbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@devilbot.on(admin_cmd(pattern="cube ?(.*)"))
@devilbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
