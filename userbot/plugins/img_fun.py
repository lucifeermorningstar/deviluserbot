...
from userbot import CmdHelp, CMD_HELP, LOGS, bot as devilbot
...
@devilbot.on(admin_cmd(pattern="invert$", outgoing=True))
@devilbot.on(sudo_cmd(pattern="invert$", allow_sudo=True))
...
@devilbot.on(admin_cmd(outgoing=True, pattern="solarize$"))
@devilbot.on(sudo_cmd(pattern="solarize$", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
...
@devilbot.on(admin_cmd(outgoing=True, pattern="mirror$"))
@devilbot.on(sudo_cmd(pattern="mirror$", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
...
@devilbot.on(admin_cmd(outgoing=True, pattern="flip$"))
@devilbot.on(sudo_cmd(pattern="flip$", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
...
@devilbot.on(admin_cmd(outgoing=True, pattern="gray$"))
@devilbot.on(sudo_cmd(pattern="gray$", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
...
@devilbot.on(admin_cmd(outgoing=True, pattern="zoom ?(.*)"))
@devilbot.on(sudo_cmd(pattern="zoom ?(.*)", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
...
@devilbot.on(admin_cmd(outgoing=True, pattern="frame ?(.*)"))
@devilbot.on(sudo_cmd(pattern="frame ?(.*)", allow_sudo=True))
async def memes(hell):
    if hell.fwd_from:
        return
    reply = await hell.get_reply_message()
