...
class Config(object):
    ...
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "1037581197").split())
    SUPPORT_USERS = set(
        int(x) for x in os.environ.get("SUPPORT_USERS", "1037581197").split()
    )
    BEST_USERS = set(int(x) for x in os.environ.get("BEST_USERS", "1037581197").split())
    DEVLOPERS = set(
        int(x) for x in os.environ.get("DEVLOPERS_USERS", "1037581197").split()
    )
    # custom vars
    ...
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/62f8a1e2f019176ce7009.jpg"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://telegra.ph/file/62f8a1e2f019176ce7009.jpg"
    )
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/62f8a1e2f019176ce7009.jpg",
    )
