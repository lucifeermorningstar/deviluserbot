...
NO_PERM = "`I don't have sufficient permissions! Sed Owner Permission de else Gand marwao-_-`"
...
async def promote(promt):
    ...
    try:
        ...
        await hellevent.edit("`Promoted Successfully! Abb nacho bencho and Galt use kiya toh dismiss ho jayega💃🕺`")
...
async def demote(dmod):
    ...
    try:
        ...
        await hellevent.edit(NO_PERM)
        return
    await hellevent.edit("`Demoted retard Successfully..... It's Owner Choice🚶`")
    if BOTLOG:
...
async def nothanos(unbon):
    ...
    try:
        ...
        await hellevent.edit("```Unbanned Successfully. Granting another chance and Aabh nachke dekhao🚶.```")
        if BOTLOG:
